    ...
    with sqlite3.connect('evaluation.db') as db:
        ...
        # Find user If there is any take proper action
         ...
         if result:
            ...
            from subprocess import call
            call(['python','Email_Detection.py'])
...
title=tk.Label(root, text="Login Here", font=("Algerian", 30, "bold","italic"),bd=5,bg="#7F7FFF",fg="white")
title.place(x=720,y=100,width=250)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=550,y=220)
